...
# Important notes : 
# - This is a combination of no_smooth and smooth_3 setup : 
# - excluding Cosine regressors from GLM (since using savgol filter)
# - not using _brainmask.nii outputs from fmriprep
