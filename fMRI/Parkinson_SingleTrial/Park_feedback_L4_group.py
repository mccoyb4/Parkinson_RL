...
for sb in range(len(subjects)):
	...
	if subjects[sb] not in ('sub-203','sub-209', 'sub-213', 'sub-215', 'sub-115'):
		...
		sub_qval_diff_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","feedback_qval_diff")
		...
		sub_qval_diff_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","feedback_qval_diff")
		...
		sub_qval_diff_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_qval_diff")
...
for contrast in contrasts: 
	...
	Parkflow_group_qval_diff.base_dir = os.path.join(group_dir,"feedback_qval_diff","cope"+str(contrast))
