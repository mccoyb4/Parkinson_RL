...
for sb in range(len(subjects)):
	...
	if hc_or_pd == 'hc':
		...
		sub_qval_diff_workflow_dir = os.path.join(workflow_dir,subjects[sb],"train","across_runs","feedback_qval_diff")
		...
		# Qval_diff dirs
		sub_run1_qval_diff_dir = os.path.join(workflow_dir,subjects[sb],"train","run-1","feedback_qval_diff","workflow",'FE')
		sub_run2_qval_diff_dir = os.path.join(workflow_dir,subjects[sb],"train","run-2","feedback_qval_diff","workflow",'FE')
		...
		sub_qval_diff_workflow_dir = os.path.join(workflow_dir,subjects[sb],pd_on_off,"train","across_runs","feedback_qval_diff")
		...
		# Qval_diff dirs
		sub_run1_qval_diff_dir = os.path.join(workflow_dir,subjects[sb],pd_on_off,"train","run-1","feedback_qval_diff","workflow",'FE')
		sub_run2_qval_diff_dir = os.path.join(workflow_dir,subjects[sb],pd_on_off,"train","run-2","feedback_qval_diff","workflow",'FE')
