...
for sb in range(len(subjects)):
	...
	if subjects[sb] not in ('sub-203','sub-209', 'sub-213', 'sub-215', 'sub-115'):
		...
		sub_rpe_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","feedback_RPE_ortho")
		sub_arpe_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","feedback_aRPE_ortho")
		sub_qval_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","feedback_qval_ortho")
		sub_gf_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","gf_RPE_ortho")
		sub_qval_diff_feat_dir = os.path.join(sub_workflow_dir,"train","across_runs","feedback_qval_diff_ortho")
		...
		sub_rpe_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","feedback_RPE_ortho")
		sub_arpe_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","feedback_aRPE_ortho")
		sub_qval_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","feedback_qval_ortho")
		sub_gf_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","gf_RPE_ortho")
		sub_qval_diff_cope_dir = os.path.join(sub_workflow_dir,"train","run-1","feedback_qval_diff_ortho")
		...
		sub_rpe_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_RPE_ortho")
		sub_arpe_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_aRPE_ortho")
		sub_qval_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_qval_ortho")
		sub_gf_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","gf_RPE_ortho")
		sub_qval_diff_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_qval_diff_ortho")
...
for contrast in contrasts: 
	...
	Parkflow_group_rpe.base_dir = os.path.join(group_dir,"feedback_RPE_ortho","cope"+str(contrast))
...
for contrast in contrasts: 
	...
	Parkflow_group_arpe.base_dir = os.path.join(group_dir,"feedback_aRPE_ortho","cope"+str(contrast))
...
for contrast in contrasts: 
	...
	Parkflow_group_qval.base_dir = os.path.join(group_dir,"feedback_qval_ortho","cope"+str(contrast))
...
for contrast in contrasts: 
	...
	Parkflow_group_gf.base_dir = os.path.join(group_dir,"gf_RPE_ortho","cope"+str(contrast))
	...
	Parkflow_group_gf.connect([(copemerge,flame12,[('merged_file','cope_file')]),
					(varcopemerge,flame12,[('merged_file','var_cope_file')]),
					(level2model,flame12,[('design_mat','design_file'),
									('design_con','t_con_file'),
									('design_grp','cov_split_file')])
	...
	# Cluster correction
	os.chdir(os.path.join(Parkflow_group_gf.base_dir,'workflow','flame12','stats'))
...
for contrast in contrasts: 
	...
	Parkflow_group_qval_diff.base_dir = os.path.join(group_dir,"feedback_qval_diff_ortho","cope"+str(contrast))
