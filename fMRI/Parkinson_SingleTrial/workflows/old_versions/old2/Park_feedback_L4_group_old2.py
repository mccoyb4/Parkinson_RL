...
if hc_or_pd == 'hc':
	...
	if ae_or_lisa == 'ae':
		...
		if smooth == '0':
			group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/hc/group"
			workflow_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/hc"
		elif smooth == '1':
			group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/smooth_2/hc/group"
		...
		if smooth == '0':
			group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/hc/group"
			workflow_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/hc"
		elif smooth == '1':
			group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/smooth_2/hc/group"
	...
	if pd_on_off == 'on':
		...
		if ae_or_lisa == 'ae':
			...
			if smooth == '0':
				group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/pd/group/on"
				workflow_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/pd"
			elif smooth == '1':
				group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/smooth_2/pd/group/on"
			...
			if smooth == '0':
				group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/pd/group/on"
				workflow_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/pd"
			elif smooth == '1':
				group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/smooth_2/pd/group/on"
		...
		if ae_or_lisa == 'ae':
			...
			if smooth == '0':
				group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/pd/group/off"
				workflow_dir = "/home/shared/2016/Parkinson/single_trial_analysis/no_smooth_2/pd"
			elif smooth == '1':
				group_dir = "/home/shared/2016/Parkinson/single_trial_analysis/smooth_2/pd/group/off"
				workflow_dir = "/home/shared/2016/Parkinson/single_trial_analysis/smooth_2/pd"
			...
			if smooth == '0':
				group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/pd/group/off"
				workflow_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/no_smooth_2/pd"
			elif smooth == '1':
				group_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/smooth_2/pd/group/off"
				workflow_dir = "/nfs/bromccoy/Parkinson/single_trial_analysis/smooth_2/pd"
...
for sb in range(len(subjects)):
	...
	if subjects[sb] not in ('sub-203','sub-209', 'sub-213', 'sub-215', 'sub-115'):
		...
		sub_feedback_only_cope_dir = os.path.join(sub_workflow_dir,"train","run-2","feedback_only")
...
for contrast in contrasts: 
	...
	Parkflow_group_arpe.connect([(copemerge,flame1,[('merged_file','cope_file')]),
					(varcopemerge,flame1,[('merged_file','var_cope_file')]),
					(level2model,flame1,[('design_mat','design_file'),
									('design_con','t_con_file'),
									('design_grp','cov_split_file')])
	...
	# Cluster correction
	os.chdir(os.path.join(Parkflow_group_arpe.base_dir,'workflow','flame1','stats'))
...
for contrast in contrasts: 
	...
	Parkflow_group_qval.connect([(copemerge,flame1,[('merged_file','cope_file')]),
					(varcopemerge,flame1,[('merged_file','var_cope_file')]),
					(level2model,flame1,[('design_mat','design_file'),
									('design_con','t_con_file'),
									('design_grp','cov_split_file')])
	...
	# Cluster correction
	os.chdir(os.path.join(Parkflow_group_qval.base_dir,'workflow','flame1','stats'))
