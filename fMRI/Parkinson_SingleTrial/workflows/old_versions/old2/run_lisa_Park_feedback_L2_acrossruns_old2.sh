...
for s in "${subs[@]}";
do
    python /home/bromccoy/bash_scripts/Park_pipeline/Park/Parkinson_SingleTrial/workflows/old_versions/old_2/Park_feedback_L2_acrossruns_old2.py $s 'pd' 'off' '0' 'lisa'
done